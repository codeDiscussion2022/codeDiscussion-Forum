...
<body>
                ...
                echo    '<div class="col-md-4 my-2">
                         <div class="card">
                            <img src="partials/img/card' . $row['category_id'] . '.jpg"
                             class="card-img-top" alt="..." style="max-height:30vh;">
                        <div class="card-body">
    ...
    <hr>
    <div class="container my-3">
        <h2 class="text-center mx-3 my-3">Welcome to codeDiscussion-Blogs</h2>
        <div class="row">
            <!-- Fetch all blogs -->
                <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo    '<div class="col-md-4 my-2">
                         <div class="card">
                         <img src="https://source.unsplash.com/random/300×200/?coding,' . $row['blog_language'] . ',python,javascript,webdevelopment" class="mh-25" alt="' . $row['blog_name'] . '"  style="height:150px;width:100%">
                         <strong class="d-inline-block mb-2 text-primary">' . $row['blog_language'] . '</strong>
                        <div class="card-body">
                        <h5 class="card-title"><a href="blog.php?blogid=' .$row['blog_id']. '">' . substr($row['blog_name'], 0, 30) . '</a></h5>
                        <p class="card-text">' . substr($row['blog_description'], 0, 150) . '....</p>
                        <strong class="d-inline-block mb-2 text-primary my-2">Posted by- ' . $row['blog_writer'] . '</strong>
                        <a href="blog.php?blogid=' . $row['blog_id'] . '" class="btn btn-success">View blog</a>
                    </div>
                </div>
            </div>';
            }
